...
const CSV_TEMPLATE = `vin,plateNumber,make,model,year,eventType,eventDate,mileage,sourceSystem,description
    ...
    <main className="page">
      ...
      <section className="admin-card" aria-labelledby="csv-template-heading">
        ...
        <p className="admin-help">
          ...
          <span className="mono">plateNumber</span>, <span className="mono">mileage</span>,{" "}
      ...
      <section className="admin-card" aria-labelledby="validation-heading">
        ...
        <ul className="plain-list">
          ...
          <li>Rows with the same VIN must not conflict on make, model, year, or non-empty plate number.</li>
        </ul>
      </section>
    </main>
  );
